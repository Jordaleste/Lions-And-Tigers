...
//  Lions and Tigers
//
//  Created by Charles Eison on 1/15/15.
...
class ViewController: UIViewController {
    ...
    // because we are in class ViewController, these variables are propertys of this class, and can be called with the self keyword in this class
